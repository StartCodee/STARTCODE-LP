...
const Portfolio = () => {
  ...
  // Tambah categoryKey biar filter bisa bilingual
  const projects = [
    {
      id: 1,
      categoryKey: "web",
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          {visibleProjects < filteredProjects.length && (
            <div className="text-center">
              <Button onClick={loadMore} variant="outline" size="lg" className="px-8 hover:bg-muted/50">
          ...
          <DialogContent className="sm:max-w-4xl">
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="font-semibold mb-3">{t("portfolioSection.modal.overview")}</h3>
                  <p className="text-muted-foreground mb-4">{selectedProject.description}</p>
                  <div className="space-y-3">
                    <div>
                      <strong>{t("portfolioSection.modal.client")}:</strong> {selectedProject.client}
                    </div>
                    <div>
                      <strong>{t("portfolioSection.modal.year")}:</strong> {selectedProject.year}
                    </div>
                    <div>
                      <strong>{t("portfolioSection.modal.category")}:</strong> {categoryLabel(selectedProject.categoryKey)}
                    </div>
                  </div>
                </div>

                <div>
                  <h3 className="font-semibold mb-3">{t("portfolioSection.modal.keyFeatures")}</h3>
                  ...
                  <h3 className="font-semibold mb-3">{t("portfolioSection.modal.results")}</h3>
                  <p className="text-muted-foreground mb-4">{selectedProject.results}</p>
                </div>
              </div>
